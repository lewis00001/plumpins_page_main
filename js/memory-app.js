$(document).ready(function () {
    ...
    const puzzle = [
        ...
        ["blue", "yellow", "off", "off",
            ...
            "off", "white", "blue", "yellow",
            "off", "off", "orange", "purple",
        ],
        // level 7
        ["white", "orange", "orange", "yellow",
            "orange", "blue", "purple", "orange",
            "orange", "yellow", "white", "orange",
            "purple", "orange", "orange", "blue",
        ],
        // level 8
        ["blue", "purple", "white", "off",
            "yellow", "orange", "off", "white",
            "white", "off", "blue", "purple",
            "off", "white", "yellow", "orange",
        ], 
        // level 9
        ...
        ["yellow", "purple", "white", "orange",
            ...
            "white", "orange", "purple", "blue",
            "yellow", "purple", "white", "yellow",
        ]
    ];
